...
public class teststudent3 {
	public static void main(String[] args) {
		...
		for (student students : s) {
			...
			// throw the Exception in object type
...
//			}
			...
			// 1.method use one method
			try {
				// nullpointerException
				// isEmpty() method
				// use trim method is empty checks also blank
				// its check total problem on Strings
				if (students.getName().trim().isEmpty()) {
					throw new IsEmpotyException(" isempty");
				}
